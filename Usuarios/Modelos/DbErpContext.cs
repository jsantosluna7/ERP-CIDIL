...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PrestamosEquipo>(entity =>
        {
            ...
            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.PrestamosEquipoIdUsuario)
                .HasForeignKey(d => d.IdUsuario)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("prestamos_equipos_id_usuario_fkey");

            entity.HasOne(d => d.IdUsuarioAprobadorNavigation).WithMany(p => p.PrestamosEquipoIdUsuarioAprobador)
        ...
        modelBuilder.Entity<ReservaDeEspacio>(entity =>
        {
            ...
            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.ReservaDeEspacioIdUsuario)
                .HasForeignKey(d => d.IdUsuario)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("prestamos_espacios_id_usuario_fkey");

            entity.HasOne(d => d.IdUsuarioAprobadorNavigation).WithMany(p => p.ReservaDeEspacioIdUsuarioAprobador)
                .HasForeignKey(d => d.IdUsuarioAprobador)
