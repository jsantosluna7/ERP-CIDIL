...
namespace Usuarios.Implementaciones.Servicios
{
    ...
    public class ServicioLike : IServicioLike
    {
        private readonly IRepositorioLike _repo;
        private readonly IUsuarioRepositorio _usuarioRepo;

        public ServicioLike(IRepositorioLike repo, IUsuarioRepositorio usuarioRepo)
        {
